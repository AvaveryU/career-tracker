# Generated by Django 3.2.3 on 2023-10-21 17:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.position', verbose_name='Позиция')),
            ],
        ),
        migrations.CreateModel(
            name='StudentUser',
            fields=[
                ...
                ('training_status', models.ManyToManyField(blank=True, through='users.StudentPosition', to='users.Position', verbose_name='Предпочтительные должности')),
        ...
        migrations.AddField(
            ...
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_positions', to='users.studentuser', verbose_name='Студент'),
        ),
