# Generated by Django 3.2.3 on 2023-10-21 08:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('frontend_dev', 'Фронтенд-разработчик'), ('fullstack_dev', 'Фулстек-разработчик'), ('python_dev', 'Python-разработчик'), ('qa_engineer', 'Инженер по тестированию'), ('java_dev', 'Java-разработчик'), ('data_scientist', 'Специалист по data-science')], max_length=150, verbose_name='Должность')),
            ],
        ),
        migrations.CreateModel(
            name='Skill',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('positions', models.ManyToManyField(blank=True, to='users.Position', verbose_name='Предпочтительные должности')),
